...
use cosmwasm_std::{from_json, to_json_binary, CosmosMsg, Uint128, WasmMsg};
use cw20::{Cw20ExecuteMsg, Cw20ReceiveMsg};

use crate::contract::{execute, instantiate, query};
use crate::msg::{
    Cw20HookMsg, ExecuteMsg, InstantiateMsg, Milestone, QueryMsg, VestingCreation, VestingResponse,
    VestingSchedule,
};
...
fn test_batch_create() {
    ...
    let stats: crate::msg::GlobalStatsResponse = from_json(
        &query(
            deps.as_ref(),
            mock_env(),
            QueryMsg::GlobalStats {
